    ...
    <div className="sv">
      <div className="sv_top">
        <div className="sv_top_text">
          <h2 className="sv_top_text_title">SV94-3</h2>
          <h2 className="sv_top_text_price">от 11 999 990 руб</h2>
        </div>
      ...
      <div className="sv_fot">
        <WannaProjectScript project={"SV943"} />
      </div>
      <Footer />
    </div>
  );
